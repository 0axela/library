...
{"numero" : 1, "etat" : "bon", "disponible" : "false"},
{"numero" : 2, "etat" : "neuf", "disponible" : "true"},
{"numero" : 3, "etat" : "bon", "disponible" : "true"}
]');
INSERT INTO ressource VALUES (DEFAULT, 'Star Wars V',  '1980-10-02',  'lucasfilm',  '242LUC',  19.99, '[
{"numero" : 1, "etat" : "bon", "disponible" : "true"},
{"numero" : 2, "etat" : "neuf", "disponible" : "false"},
{"numero" : 3, "etat" : "abime", "disponible" : "true"}
]');
INSERT INTO ressource VALUES (DEFAULT, 'Star Wars VI', '1983-04-23',  'lucasfilm',  '243LUC', 19.99, , '[
{"numero" : 1, "etat" : "bon", "disponible" : "true"},
{"numero" : 2, "etat" : "neuf", "disponible" : "true"},
{"numero" : 3, "etat" : "neuf", "disponible" : "false"}
]');
INSERT INTO ressource VALUES (DEFAULT, 'Candide', '1959-01-20', 'magnard', '211VOL', 2.95, '[
{"numero" : 1, "etat" : "bon", "disponible" : "true"},
{"numero" : 2, "etat" : "bon", "disponible" : "true"}
]');
...
{"numero" : 1, "etat" : "abime", "disponible" : "true"},
{"numero" : 2, "etat" : "bon", "disponible" : "true"}
]');
INSERT INTO ressource VALUES (DEFAULT, 'Allumez le feu', '1998-01-16', 'Universal', '121HAL', 5, '[{"numero" : 1, "etat" : "neuf", "disponible" : "true"}
]');
INSERT INTO ressource VALUES (DEFAULT, 'Debout', '1998-01-16', 'Universal', '122HAL', 5, , '[{"numero" : 1, "etat" : "bon", "disponible" : "true"}]');
...
INSERT INTO livre (code,isbn,resume,langue,nb_pages,auteur, details) VALUES (5,  '978-3-11-125672-9',  'Julien Sorel est le troisième fils du vieux Sorel, scieur, qui n’a que mépris pour les choses intellectuelles et donc pour Julien, qui se révèle très tôt doué pour les études. Au contraire de ses frères, le garçon n’est pas taillé pour les travaux de force, et sa curiosité le pousse à s’instruire par tous les moyens possibles.',  'francais',  '556',  10, '{"type" : "roman", "codebarre" : "ABD-abd-1237"}');
INSERT INTO livre (code,isbn,resume,langue,nb_pages,auteur, details) VALUES (6,  '178-2-01-169169-9',  'Au temps de l’URSS de Staline, le reporter Tintin et son fox-terrier Milou sont envoyés à Moscou par Le Petit Vingtième afin d’y effectuer un reportage. Informés de son départ et des raisons de sa venue, les Soviétiques dépêchent un agent secret afin de le tuer, et font exploser son train, alors en Allemagne.',  'francais',  '36',  7, '{"type" : "bd", "codebarre" : "XYZ-xyz-1234"}');

INSERT INTO musique VALUES(7, 210, 'hymne', 8, '{"ventes" : 82700}');
INSERT INTO musique VALUES(8, 225, 'rock', 6, '{"ventes" : 20030}');
INSERT INTO musique VALUES(9, 250, 'rock', 6, '{"ventes" : 500000}');

INSERT INTO film (code,synopsis,langue,duree,realisateur, details) VALUES ( 1,
...
INSERT INTO film (code,synopsis,langue,duree,realisateur, details) VALUES ( 3,
